...
> **Public repo note:** Internal runbooks under `docs/` are not published. Use repo root **[ARCHITECTURE.md](../ARCHITECTURE.md)** (HLD/LLD), **[GETTING_STARTED.md](../GETTING_STARTED.md)**, **[TECHNOLOGY_STACK.md](../TECHNOLOGY_STACK.md)**; keep phase docs locally if you need them.
